<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级号" prop="banjihao">
          <el-input v-model="ruleForm.banjihao" 
              placeholder="班级号" clearable  :readonly="ro.banjihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级号" prop="banjihao">
              <el-input v-model="ruleForm.banjihao" 
                placeholder="班级号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="班主任" prop="banzhuren">
          <el-select  @change="banzhurenChange" v-model="ruleForm.banzhuren" placeholder="请选择班主任">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.banzhuren" label="班主任" prop="banzhuren">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="班级详情" prop="banjixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.banjixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.banjixiangqing" label="班级详情" prop="banjixiangqing">
                    <span v-html="ruleForm.banjixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='banjixiangqing'){
            this.ruleForm.banjixiangqing = obj[o];
	    this.ro.banjixiangqing = true;
            continue;
          }
          if(o=='clicktime'){
    ...
    banzhurenChange () {
      this.$http({
        url: `follow/jiaoshi/jiaoshizhanghao?columnValue=`+ this.ruleForm.banzhuren,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.banjixiangqing = this.ruleForm.banjixiangqing.replace(reg,'../../../springboot0e3m2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
