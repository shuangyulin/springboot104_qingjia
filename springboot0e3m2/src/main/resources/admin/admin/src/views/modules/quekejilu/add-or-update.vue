<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺勤次数" prop="queqincishu">
          <el-input v-model="ruleForm.queqincishu" 
              placeholder="缺勤次数" clearable  :readonly="ro.queqincishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺勤次数" prop="queqincishu">
              <el-input v-model="ruleForm.queqincishu" 
                placeholder="缺勤次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='queqincishu'){
            this.ruleForm.queqincishu = obj[o];
	    this.ro.queqincishu = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot0e3m2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `quekejilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.quekejiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
